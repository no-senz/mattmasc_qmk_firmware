...
//|---------------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+----------------+--------+|
        KC_TAB,     KC_Q,    KC_W,    KC_F,    KC_P,     KC_B,   KC_LBRC,  KC_J,    KC_L,    KC_U,    KC_Y,  KC_QUOT,  KC_SLSH,     KC_BSLS,    KC_DELETE,
//|----------------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+------------------------+--------+|
      KC_CAPS,    HOME_A,  HOME_R,  HOME_S,  HOME_T,   KC_G,   KC_RBRC,  KC_M,   HOME_N,  HOME_E,  HOME_I,  HOME_O,            KC_ENT,         KC_PGUP,
//|-----------------------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+-----------------+--------+--------+|
            KC_LSFT,         KC_X,    KC_C,    KC_D,    KC_V,    KC_Z,  KC_SCLN,   KC_K,    KC_H,  KC_COMM,  TD_DOT,       KC_RSFT,     KC_UP,   KC_PGDN,
//|------------+------------+------------+--------------------------------------------------------+--------+--------+--------+--------+--------+--------+|
...
//,--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+-----------------------+--------+.
    KC_ESC,   KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,  KC_MINS,  KC_EQL,          KC_BSPC,         KC_INS,
//|---------------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+----------------+--------+|
        KC_TAB,    KC_SCLN,   KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,  KC_LBRC,     KC_RBRC,     KC_DELETE,
//|----------------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+------------------------+--------+|
...
//,--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+-----------------------+--------+.
   KC_TRNS,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,        KC_TRNS,        KC_TRNS,
//|---------------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+----------------+--------+|
       KC_TRNS,     KC_PAST,  KC_P6,   KC_P5,  KC_P4,  KC_PPLS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,WIN_SELWORD,KC_TRNS,KC_TRNS,     KC_TRNS,    KC_TRNS,
//|----------------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+------------------------+--------+|
        KC_TRNS,     KC_P3,   KC_P2,   KC_P1,   KC_P0,  KC_PEQL, KC_TRNS, KC_TRNS, KC_LCTL, KC_LSFT, KC_LALT,  KC_LGUI,         KC_TRNS,        KC_TRNS,
//|-----------------------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+-----------------+--------+--------+|
           KC_TRNS,         KC_PSLS, KC_P9,   KC_P8,    KC_P7,  KC_PMNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,      KC_TRNS,     KC_TRNS,  KC_TRNS,
//|------------+------------+------------+--------------------------------------------------------+--------+--------+--------+--------+--------+--------+|
      KC_TRNS,    KC_TRNS,     KC_TRNS,                                KC_TRNS,                    KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,  KC_TRNS
//`------------+------------+------------+--------------------------------------------------------+--------+--------+--------+--------+--------+--------+'
    ),
...
//,--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+-----------------------+--------+.
   KC_TRNS,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,        KC_TRNS,        KC_TRNS,
//|---------------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+----------------+--------+|
       KC_TRNS,    KC_TRNS,  KC_DLR, KC_PLUS, KC_SLSH, KC_UNDS, KC_TRNS,   KC_AT, KC_AMPR, KC_PIPE, NODK_DQT, KC_HASH, KC_TRNS,     KC_TRNS,    KC_TRNS,
//|----------------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+------------------------+--------+|
        KC_TRNS,    KC_ASTR, KC_QUES, KC_EXLM, KC_COLN, KC_SCLN, CW_TOGG,  KC_EQL, KC_LPRN, KC_LCBR, KC_LBRC, KC_MINS,         KC_TRNS,        KC_TRNS,
//|-----------------------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+-----------------+--------+--------+|
...
//|---------------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+----------------+--------+|
       KC_TRNS,    BT_HST1, BT_HST2, BT_HST3, KC_TRNS, BAT_LVL, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,      KC_TRNS,     KC_TRNS,
//|----------------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+------------------------+--------+|
        RGB_TOG,    RGB_MOD,  RGB_VAI, RGB_HUI, RGB_SAI, RGB_SPI, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,         KC_TRNS,        AC_TOGG,
//|-----------------------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+-----------------+--------+--------+|
...
//|------------+------------+------------+--------------------------------------------------------+--------+--------+--------+--------+--------+--------+|
     KC_LCTL,  KC_LOPTN, KC_LCMMD,                               KC_SPC,                       KC_RCMMD,MO(_MAC_FN1),MO(_GAME),KC_LEFT,KC_DOWN,KC_RGHT
//`------------+------------+------------+--------------------------------------------------------+--------+--------+--------+--------+--------+--------+'
    ),
    ...
    switch (keycode) {
        case REPEAT_NAV:
            if (record->tap.count) {
                ...
                update_tri_layer(_NAV, _NUM, _MACRO);
            } else {
                layer_off(_NAV);
                update_tri_layer(_NAV, _SYM, _FUN);
                update_tri_layer(_NAV, _NUM, _MACRO);
        ...
        case SPC_SYM:
            if (record->tap.count && record->event.pressed) {
                ...
                layer_on(_SYM);
                update_tri_layer(_SYM, _NAV, _SETT);
                update_tri_layer(_SYM, _NUM, _FUN);
            } else {
                layer_off(_SYM);
                update_tri_layer(_SYM, _NAV, _SETT);
                update_tri_layer(_SYM, _NUM, _FUN);
        ...
        case GRV_NUM:
            if (record->tap.count && record->event.pressed) {
                ...
                layer_on(_NUM);
                update_tri_layer(_NUM, _NAV, _MACRO);
